...
<tr>
	...
	<td id="{{!m.id}}">
		<button class="btn btn-primary works-list-bg" data-olds="{{!m.new_shouquanren}}" data-oldb="{{!m.new_beishouquanren}}" data-toggle="modal" data-target="#modal-changeRights">权利变更</button>
