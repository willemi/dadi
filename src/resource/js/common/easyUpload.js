		...
		this.each(function (index, element) {
			...
			var easyManager = {
				init: function () {
					...
					$html += '<i class="easyUploadIcon noselect head_check" data-checked="yes">&#xe693;</i>';
				...
				_renderFile: function (fileArr, target) {
					...
					function render(file) {
						...
						$html += '<p class="easy_upload_percent" style="display:none">0%</p>';
						$html += '<p class="easy_upload_progress">';
						$html += '<span class="easy_upload_bar"></span>';
						$html += '</p>'
						$html += '</div>';
						$html += '<div class="easy_upload_file3 queue_item-section">';
						...
						$html += '</div>';
						$html += '<div class="easy_upload_checkone queue_item-section" style="width:0px;overflow:hidden">';
